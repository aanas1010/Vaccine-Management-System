...
public class ManagementSystemException extends Exception {
    ...
    public final static String CLINIC_ID_ALREADY_EXISTS =
            "Could not add the clinic because a clinic already exists with the provided ID";

    public final static String BATCH_ID_ALREADY_EXISTS =
    ...
    public final static String TIME_PERIOD_DOES_NOT_EXIST =
            "Could not remove the time period because it does not exist";
    ...
    public final static String CLINIC_DOES_NOT_HAVE_TIMESLOT =
            "The provided timeslot could not be found for this clinic";

    public final static String APPOINTMENT_ID_ALREADY_EXISTS =
            "Could not book the appointment because an appointment already exists with the provided ID";
    public final static String TIME_SLOT_UNAVAILABLE = "The timeslot provided has no availabilities";
    public final static String CLIENT_ALREADY_HAS_APPOINTMENT =
            "Could not book the appointment because this client already has an appointment";
